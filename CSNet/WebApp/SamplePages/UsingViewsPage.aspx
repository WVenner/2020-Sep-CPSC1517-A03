...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-12 text-center">
            <asp:Label ID="Label1" runat="server" Text="Select a Category to view products:"></asp:Label>
            &nbsp;&nbsp;
            <asp:DropDownList ID="CategoryList" runat="server" DataSourceID="CategoryListODS" DataTextField="CategoryName" DataValueField="CategoryName"
                 AppendDataBoundItems="true">
                <asp:ListItem Value="">select ...</asp:ListItem>
            </asp:DropDownList>
            &nbsp;&nbsp;
            <asp:LinkButton ID="Search" runat="server"><i class="fa fa-search"></i>Search</asp:LinkButton>
        </div>
    </div>
    <div class="row">
        <div class="offset-4">
            <h4>Products of Category</h4>
            <asp:GridView ID="CategoryProductsList" runat="server" AutoGenerateColumns="False" DataSourceID="CategoryProductListODS" AllowPaging="True">
    ...
    <asp:ObjectDataSource ID="CategoryProductListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Views_ProductsOfCategory" TypeName="NorthwindSystem.BLL.ViewController">

        <SelectParameters>
            <asp:ControlParameter ControlID="CategoryList" PropertyName="SelectedValue" DefaultValue="uybuiybu" Name="category" Type="String"></asp:ControlParameter>
        </SelectParameters>
    </asp:ObjectDataSource>
</asp:Content>
